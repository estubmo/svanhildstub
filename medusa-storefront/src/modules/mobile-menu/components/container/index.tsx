...
const Container = ({ children }: ContainerProps) => {
  ...
  return (
    <Transition.Root show={state} as={Fragment}>
      <Dialog as="div" className="fixed inset-0 z-40 flex" onClose={close}>
        <Transition.Child
          as={Fragment}
        ...
        >
          <div className="absolute inset-0 overflow-hidden">
            <div className="right-left pointer-events-none fixed inset-y-0 flex max-w-full">
              <div className="pointer-events-auto relative flex w-screen flex-col overflow-y-auto bg-ui-bg-base text-ui-fg-base">
                {children}
              </div>
            </div>
          </div>
