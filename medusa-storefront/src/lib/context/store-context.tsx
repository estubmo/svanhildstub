...
interface StoreContext {
  ...
  setRegion: (_regionId: string, _countryCode: string) => void;
  addItem: (_item: VariantInfoProps) => void;
  updateItem: (_item: LineInfoProps) => void;
  deleteItem: (_lineId: string) => void;
  resetCart: () => void;
}
