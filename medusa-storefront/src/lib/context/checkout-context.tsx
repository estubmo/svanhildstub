...
interface CheckoutContext {
  ...
  setAddresses: (_addresses: CheckoutFormValues) => void;
  setSavedAddress: (_address: Address) => void;
  setShippingOption: (_soId: string) => void;
  setPaymentSession: (_providerId: string) => void;
